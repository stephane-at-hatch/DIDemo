...
public protocol TestDependencyProvider: DependencyRequirements {
    ...
    @MainActor
    static func mockRegistration(in mockBuilder: MockDependencyBuilder<Self>)
}
...
extension TestDependencyProvider {
    ...
    @MainActor
    static func _callMockRegistration(in mockBuilder: Any, parent: AnyFrozenContainer?, skipValidation: Bool = false) {
        guard let typedBuilder = mockBuilder as? DependencyBuilder<Self> else {
